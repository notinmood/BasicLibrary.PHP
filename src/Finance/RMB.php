...
class RMB
{
     ...
     */
    public static function displayChineseValue(float|int $num, bool $financeMode = true, bool $simpleMode = true): string
    {
        if (!is_numeric($num)) {
            return '含有非数字非小数点字符！';
        }
        ...
        //整数部分
        $str = $financeMode ? strrev((int)$num) : strrev($num);
        $out = null;
        ...
        return implode('', array_reverse($out)) . $result;
    }
}
